...
namespace pingu
{
    public partial class MisPost : Form
    {
        ...
        private async void MisPost_Load(object sender, EventArgs e)
        {
        ...
        private void btnInicio_Click(object sender, EventArgs e)
        {
            ...
            if (respuesta == DialogResult.Cancel || respuesta == DialogResult.OK || respuesta == DialogResult.Abort)
                this.Close();
        }
        ...
        private void MisPost_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (cerrandoSesion)
            {
